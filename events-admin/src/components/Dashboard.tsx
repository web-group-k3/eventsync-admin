...
export const Dashboard = () => {
    ...
    return (
        <Container maxWidth={false} sx={{ padding: { xs: 2, md: 4 }, backgroundColor: '#0b0f19', minHeight: '100vh', color: '#ffffff', width: '100%' }}>
            ...
            <Grid container spacing={3} mb={5}>
                <Grid item xs={12} sm={4}>
                    <Card sx={{ backgroundColor: '#111827', border: '1px solid #1f2937', borderRadius: '16px', padding: 3, boxShadow: 'none' }}>
            ...
            <Grid container spacing={3} alignItems="stretch">
                ...
                <Grid item xs={12} md={8}>
                    <Card sx={{ backgroundColor: '#111827', border: '1px solid #1f2937', borderRadius: '20px', padding: 3, boxShadow: 'none', height: '100%' }}>
                                ...
                                <Table sx={{ width: '100%', tableLayout: 'fixed' }}>
                                    <TableHead>
                                        <tr style={{ borderBottom: '1px solid #1f2937' }}>
                                            <th style={{ textAlign: 'left', padding: '12px', color: '#9ca3af', fontSize: '0.85rem', width: '40%' }}>EVENT NAME</th>
                                            <th style={{ textAlign: 'left', padding: '12px', color: '#9ca3af', fontSize: '0.85rem', width: '25%' }}>LOCATION</th>
                                            <th style={{ textAlign: 'left', padding: '12px', color: '#9ca3af', fontSize: '0.85rem', width: '20%' }}>START DATE</th>
                                            <th style={{ textAlign: 'right', padding: '12px', color: '#9ca3af', fontSize: '0.85rem', width: '15%' }}>ACTIONS</th>
                                        </tr>
                                    </TableHead>
                                    <TableBody>
                ...
                {/* BLOC DROITE : LIVE STATUS (4 colonnes nettes) */}
                <Grid item xs={12} md={4}>
                    <Card sx={{ backgroundColor: '#111827', border: '1px solid #1f2937', borderRadius: '20px', padding: 3, boxShadow: 'none', height: '100%', display: 'flex', flexDirection: 'column' }}>
                        <Typography variant="h6" sx={{ fontWeight: 700, mb: 3 }}>
                            Live Status
                        </Typography>

                        {loadingList ? (
                            <Typography sx={{ color: '#9ca3af' }}>Checking dates...</Typography>
                                ...
                                {ongoingEvents.map((event: any) => (
                                    ...
                                    >
                                        <Box sx={{ overflow: 'hidden', mr: 1 }}>
                                            <Typography variant="body2" sx={{ fontWeight: 600, color: '#ffffff', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                                                {event.title || event.name || `Event #${event.id}`}
                                            </Typography>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, backgroundColor: 'rgba(163, 255, 18, 0.1)', px: 1.2, py: 0.6, borderRadius: '6px', flexShrink: 0 }}>
                            ...
                            <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" sx={{ flexGrow: 1, py: 4, opacity: 0.6 }}>
                                <Typography variant="body2" sx={{ color: '#9ca3af', textAlign: 'center', fontWeight: 500 }}>
