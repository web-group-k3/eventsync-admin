...
export const Dashboard = () => {
  const { total: totalEvents, isLoading: loadingEvents } = useGetList(
    "events",
    { pagination: { page: 1, perPage: 1 } },
  );
  const { total: totalSessions, isLoading: loadingSessions } = useGetList(
    "sessions",
    { pagination: { page: 1, perPage: 1 } },
  );
  const { total: totalSpeakers, isLoading: loadingSpeakers } = useGetList(
    "speakers",
    { pagination: { page: 1, perPage: 1 } },
  );
  const { total: totalRooms, isLoading: loadingRooms } = useGetList("rooms", {
    pagination: { page: 1, perPage: 1 },
  });
          ...
          >
            {loadingList ? (
              ...
              <Box display="flex" alignItems="center" gap={1.5}>
                <RadioButtonCheckedIcon
                  sx={{ color: "#9ca3af", fontSize: "1.2rem", opacity: 0.4 }}
                />
                <Box>
                  <Typography
                    variant="caption"
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: "#9ca3af", fontWeight: 600, mt: 0.5 }}
                  >
                    No events today
                  </Typography>
                </Box>
                      ...
                      >
                        ...
                        >
                          <Button
                            ...
                            onClick={() =>
                              (window.location.hash = `#/events/${event.id}/show`)
                            }
                            sx={{
                              color: "#ffffff",
                              backgroundColor: "rgba(255,255,255,0.05)",
